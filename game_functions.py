# -*- coding: utf-8 -*-
"""
Created at 26 Feb 2018 22:17:10
Author : DaxiaLuo
"""
...
def start_new_level(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """如果整群外星人被消灭，则等级提升"""
    if len(aliens) == 0:
        # 如果整群外星人被消灭，则删除现有的子弹,加快游戏节奏，并新建一批外星人
        bullets.empty()
...
def check_alliens_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets):
    """检查是否 有外星人到达屏幕底端"""
...
def update_aliens(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    # 检查是否有外星人到达屏幕底端
    check_alliens_bottom(ai_settings, stats, screen, sb, ship, aliens, bullets)
...
def save_highest_score(stats):
    """保存游戏的最高分"""
    with open('/home/luojuntao/Documents/LearningPython/alien_invasion/datas/highest_score.txt', 'w') as f:
